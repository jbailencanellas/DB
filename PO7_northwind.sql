...
from Shippers SP, Orders O

where SP.ShipperID = O.ShipVia
...
count(O.ShipVia) as NumTimes

from Employees E, Shippers SP, Orders O

where E.EmployeeID = O.EmployeeID

and O.ShipVia = SP.ShipperID

group by FullName, SP.CompanyName
